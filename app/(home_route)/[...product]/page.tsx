...
export default async function Product({ params }: Props) {
    ...
    return (
        <div className='p-5'> <ProductView title={productInfo.title} description={productInfo.description} price={productInfo.price} sale={productInfo.sale} points={productInfo.bulletPoints} images={productImages} /></div>
    )
}
